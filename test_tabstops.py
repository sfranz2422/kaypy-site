...
The two handlers are pulled out of the shipped play.js and run here against
...
check("indentToTabStop was found in play.js", len(tab_fn) > 100, "%d chars" % len(tab_fn))
check("backspaceToTabStop was found in play.js", len(back_fn) > 100,
      "%d chars" % len(back_fn))
